{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "GeoViews provides a number of tile sources by default, provided by CartoDB, Stamen, OpenStreetMap, and Esri. These can be imported from the ``geoviews.tile_sources`` module."
   ]
  },
  {
   "cell_type": "code",
